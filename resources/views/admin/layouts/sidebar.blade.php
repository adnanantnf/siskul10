        ...
        <li class="nav-item">
            ...
            <div id="navecommerce" class="collapse "
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link has-arrow "
                            href="pages/ecommerce-products-details.html">
                    ...
                    <li class="nav-item">
                        <a class="nav-link has-arrow "
                            href="pages/ecommerce-product-edit.html">
                    ...
                    <li class="nav-item">
                       <a class="nav-link has-arrow "
                           href="pages/ecommerce-order-list.html">
                   ...
                   <li class="nav-item">
                       <a class="nav-link has-arrow "
                           href="pages/ecommerce-order-detail.html">
                   ...
                   <li class="nav-item">
                       <a class="nav-link has-arrow "
                           href="pages/ecommerce-customer.html">
                   ...
                   <li class="nav-item">
                       <a class="nav-link has-arrow "
                           href="pages/ecommerce-seller.html">
        ...
        <li class="nav-item">
            ...
            <div id="navKanban" class="collapse "
                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link has-arrow "
                            href="pages/task-kanban-grid.html">
                    ...
                    <li class="nav-item">
                        <a class="nav-link has-arrow "
                            href="pages/task-kanban-list.html">
...
<li class="nav-item">
<a class="nav-link  "
   href="pages/apps-file-manager.html">
...
<div id="navinvoice" class="collapse "
   ...
   <ul class="nav flex-column">
       ...
       <li class="nav-item">
           <a class="nav-link has-arrow "
               href="pages/invoice-detail.html">
       ...
       <li class="nav-item">
           <a class="nav-link has-arrow "
               href="pages/invoice-generator.html">
           ...
           <div id="navComponents" class="collapse "
               ...
               <ul class="nav flex-column">
                   ...
                   <li class="nav-item">
                     ...
                     <li class="nav-item">
                       <a class="nav-link "
                           href="pages/components/alerts.html"> Alert</a>
                   </li>
                     ...
                     <li class="nav-item">
                       <a href="pages/components/forms.html" class="nav-link ">
                         Forms
                       </a>
                     </li>
